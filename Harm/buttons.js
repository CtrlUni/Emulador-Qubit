 ...
 */
!function() {
    "use strict"; var e = window.document,
    o = e.location,
    t = window.Math,
    ...
    h = function(e) {
        return function(o, t, r) {
            var a = e.createElement(o); if (null != t)for (var n in t) {
                var i = t[n]; null != i && (null != a[n]?a[n] = i: a.setAttribute(n, i))}return null != r && u(r, (function(o) {
    ...
    v = function(e, o, t, r) {
        null == o && (o = "&"),
        null == t && (t = "="),
        null == r && (r = window.decodeURIComponent); var a = {}; return u(e.split(o), (function(e) {
            if ("" !== e) {
                var o = e.split(t); a[r(o[0])] = null != o[1]?r(o.slice(1).join(t)): void 0
            }})), a
    }, m = function(e, o, t) {
        e.addEventListener?e.addEventListener(o, t, !1): e.attachEvent("on"+o, t)}, w = function(e, o, t) {
        e.removeEventListener?e.removeEventListener(o, t, !1): e.detachEvent("on"+o, t)}, k = function(e, o, t) {
        var r = function() {
            return w(e, o, r), t.apply(this, arguments)}; m(e, o, r)}, x = function(e, o, t) {
        if (null != e.readyState) {
            var r = "readystatechange",
            a = function() {
                if (o.test(e.readyState))return w(e, r, a),
                t.apply(this, arguments)}; m(e, r, a)}},
    y = {
        ...
        light_high_contrast: ".btn:focus-visible,.social-count:focus-visible{outline:2px solid #0349b4;outline-offset:-2px}.btn{color:#0e1116;background-color:#e7ecf0;border-color:#20252c;background-image:none;filter:none}.btn:hover,.btn:focus{background-color:#d1d9df;background-position:0 -0.5em;border-color:#20252c;background-image:none;filter:none}.btn:active{background-color:#cfd6dd;border-color:#20252c}.social-count{color:#0e1116;background-color:#fff;border-color:#20252c}.social-count:hover,.social-count:focus{color:#023b95}.octicon-heart{color:#971368}",
    ...
    Z = function(e, o) {
        ...
        p(M, e) || (e = "mark-github"); var t = o >= 24 && 24 in M[e].heights?24: 16,
        r = M[e].heights[t]; return'<svg viewBox="0 0 '+r.width+" "+t+'" width="'+o*r.width/t+'" height="'+o+'" class="octicon octicon-'+e+'" aria-hidden="true">'+r.path+"</svg>"
    },
    A = {},
    F = function(e, o) {
        var t = A[e] || (A[e] = []); if (!(t.push(o) > 1)) {
            var r = g((function() {
                for (delete A[e]; o = t.shift();)o.apply(null, arguments)})); if (d) {
                var n = new a; m(n, "abort", r),
                m(n, "error", r),
                m(n, "load", (function() {
                    var e; try {
                        e = JSON.parse(this.responseText)}catch(e) {
                        return void r(e)}r(200 !== this.status, e)})),
                n.open("GET", e),
                n.send()} else {
                var i = this || window; i._ = function(e) {
                    i._ = null,
                    r(200 !== e.meta.status, e.data)}; var c = h(i.document)("script", {
                        async: !0, src: e+(-1 !== e.indexOf("?")?"&": "?")+"callback=_"
                    }),
                l = function() {
                    i._ && i._({
                        meta: {}})}; m(c, "load", l),
